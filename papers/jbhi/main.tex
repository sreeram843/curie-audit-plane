...
Mean plane latency is $14.20$\,ms versus $8.61$\,ms for the identical
unrecorded workflow (paired latency ratio $0.650$, $95\%$ interval
$[0.604, 0.697]$, $n=3$ after one warmup). Storage ratio versus that workflow is
...
application. Verification of the clean transaction is $1.06$\,ms.
